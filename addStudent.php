                      ...
                      <form class="form-horizontal style-form" method="post">
                          <div class="form-group">
                            ...
                            <div class="col-sm-10" style="margin-bottom: 10px;">
                                  <input type="text" name="s_id" id="userid" autocomplete="off" required="required" onBlur="getuserdata()" class="form-control">
                                  <br>
                            ...
                            <div class="col-sm-10" style="margin-bottom: 10px;">
                             ...
                             <div class="col-sm-10" style="margin-bottom: 10px;">
                                  <input type="text" name="mob" autocomplete="off" pattern="[6-9]{1}[0-9]{9}" required="required" class="form-control">
                              </div>

                              <label class="col-sm-2 col-sm-2 control-label">Address</label>
                              <div class="col-sm-10" style="margin-bottom: 10px;">
                                  <input type="text" name="address" autocomplete="off" required="required" class="form-control">
                              </div>
